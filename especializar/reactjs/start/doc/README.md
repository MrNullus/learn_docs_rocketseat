...
São funções feitas para ligar e conectar os recursos de estados e ciclo de vida do React a partir de componentes funcionais, isso aontence, pois, o React agora recomenda usar componentes funcionais já que conseguem ser independendes e mais faceis de usar.

~ por conveção a primeira palavra de um Hook deve ser:
`use`
...
+ Como o useEffect não aceita ser criado de modo assincrono, deve se usar uma função para chamar os dados de modo assincrono, e assim dentro do Hook chame a função:
